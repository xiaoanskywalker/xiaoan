...
foreach($lines as $line){
  ...
  if($line!=""){
    if(!($line{0}=="#" || $line{0}.$line{1}=="--")){
        mysqli_query($con,$line) or die("<b><font color='red'>执行数据库语句$line 时发生错误。</font></b><p>安装程序停止运行。<a href='./step-3.php'>返回</a>");
...
mysqli_query($con,$sql) or die("<b><font color='red'>执行数据库语句$sql 时发生错误。</font></b><p>安装程序停止运行。<a href='./step-3.php'>返回</a>");
