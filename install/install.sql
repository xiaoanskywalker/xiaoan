...
CREATE TABLE IF NOT EXISTS `wtb_titles` (`tid` mediumint(8) NOT NULL AUTO_INCREMENT,`users` text NOT NULL,`titles` text NOT NULL,`date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',`posts` text NOT NULL,`topictype` int(11) NOT NULL,PRIMARY KEY (`tid`)) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=34 ;
